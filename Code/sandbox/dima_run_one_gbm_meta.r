...
datafolder <- '01to5butterEye8ch1300ms80pca'
...
#result$Prediction = (predicted + predicted.meta) / 2
#write.table(result, paste('../../Results/subX_', datafolder, '_', mlmethod, '_meta.csv', sep=''), sep=',', quote=F, row.names=F, col.names=T)
