...
multipled[multipled < 0.4] <- 0.0
multipled[multipled > 0.8] <- 1.0
...
write.table(result, paste('../../Results/subX_metaXpcaOZ_gbm.csv', sep=''), sep=',', quote=F, row.names=F, col.names=T)
